...
customer_pw varchar(8)  NOT NULL,
propertyid varchar(20),
custadhaar varchar(12),
phoneno varchar(10),
foreign key(propertyid) REFERENCES property(propertyid) on update cascade on delete cascade,
primary key(custid));

insert into Customer values('Rajesh','Shetty','1990-11-10','abc123*','XX12','978665242745','9686288086');
insert into Customer values('Rajya','Mittal','1978-04-06','swa?456','XX13','162483945261','9873456271');
insert into Customer values('Shashi','Tagore','1993-01-20','pqrs!789','XX14','245367189523','8104536728');
insert into Customer values('Aishwarya','Gandhi','1989-08-24','pra**20','XX15','426378198253','9637245379');
insert into Customer values('Muhammed','Sadaf','1992-09-17','ms20*','XX16','635428761324','7354682435');
